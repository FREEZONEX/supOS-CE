...
INSERT INTO "public"."client" VALUES ('a7b53e5e-3567-470a-9da1-94cc0c7f18e6', 't', 't', 'supos', 0, 'f', 'VaOS2makbDhJJsLlYPt4Wl87bo9VzXiO', 'KEYCLOAK_BASE_URL_VAR/uns', 'f', 'KEYCLOAK_BASE_URL_VAR', 'f', '8920b375-d705-4d30-8a71-52d9c14ec4ba', 'openid-connect', -1, 't', 'f', '', 't', 'client-secret', 'KEYCLOAK_BASE_URL_VAR', '', NULL, 't', 'f', 't', 'f');
