...
type MenuModel struct {
	...
	// Description 菜单描述
	Description string `json:"description,optional" yaml:"description" gorm:"column:description"`
	...
	IconUrl string `json:"iconUrl,optional" yaml:"iconUrl" gorm:"column:icon_url"`
}
