...
func builtinRoutes(c config.GatewayConf) []GatewayRoute {
	...
	return []GatewayRoute{
		...
		{ID: systemGatewayRouteIDBase + 17, RouteKey: "proxy.nodered.api.source", Name: "SourceFlow Node-RED API", TargetType: "reverseProxy", MatchType: "prefix", PathPattern: "/flow/source/**", TargetUrl: c.SourceFlowUrl, StripPrefix: true, AuthPolicy: "public", ResourceKey: "flow.read", TimeoutMs: 10000, Priority: 96, Enabled: true, SystemBuiltin: true},
