...
func OpenapiUnsNodeUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.OpenapiUnsNodeSaveReq
		...
		l := uns.NewOpenapiUnsNodeUpdateLogic(r.Context(), svcCtx)
		resp, err := l.OpenapiUnsNodeUpdate(&req)
		if err != nil {
