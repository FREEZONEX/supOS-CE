...
func OpenapiUnsLabelCreateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := uns.NewOpenapiUnsLabelCreateLogic(r.Context(), svcCtx)
		resp, err := l.OpenapiUnsLabelCreate(&req)
		if err != nil {
