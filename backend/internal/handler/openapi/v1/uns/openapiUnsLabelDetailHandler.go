...
func OpenapiUnsLabelDetailHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := uns.NewOpenapiUnsLabelDetailLogic(r.Context(), svcCtx)
		resp, err := l.OpenapiUnsLabelDetail(&req)
		if err != nil {
