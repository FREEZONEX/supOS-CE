...
func OpenapiUnsBrowseHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.BrowseReq
		...
		l := uns.NewOpenapiUnsBrowseLogic(r.Context(), svcCtx)
		resp, err := l.OpenapiUnsBrowse(&req)
		if err != nil {
