...
func OpenapiUnsHistoryHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := uns.NewOpenapiUnsHistoryLogic(r.Context(), svcCtx)
		resp, err := l.OpenapiUnsHistory(&req)
		if err != nil {
