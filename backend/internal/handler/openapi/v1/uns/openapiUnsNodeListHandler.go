...
func OpenapiUnsNodeListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UnsListReq
		...
		req.ParentIdSet = r.URL.Query().Has("parentId")

		l := uns.NewOpenapiUnsNodeListLogic(r.Context(), svcCtx)
		resp, err := l.OpenapiUnsNodeList(&req)
		if err != nil {
