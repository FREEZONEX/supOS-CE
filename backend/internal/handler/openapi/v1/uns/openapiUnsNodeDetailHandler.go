...
func OpenapiUnsNodeDetailHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := uns.NewOpenapiUnsNodeDetailLogic(r.Context(), svcCtx)
		resp, err := l.OpenapiUnsNodeDetail(&req)
		if err != nil {
