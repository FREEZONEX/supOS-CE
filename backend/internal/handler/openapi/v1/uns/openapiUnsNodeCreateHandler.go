...
func OpenapiUnsNodeCreateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := uns.NewOpenapiUnsNodeCreateLogic(r.Context(), svcCtx)
		resp, err := l.OpenapiUnsNodeCreate(&req)
		if err != nil {
