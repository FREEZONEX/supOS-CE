...
func OpenapiFlowListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.FlowListReq
		...
		l := flow.NewOpenapiFlowListLogic(r.Context(), svcCtx)
		resp, err := l.OpenapiFlowList(&req)
		if err != nil {
