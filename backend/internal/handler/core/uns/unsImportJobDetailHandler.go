...
func UnsImportJobDetailHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := uns.NewUnsImportJobDetailLogic(r.Context(), svcCtx)
		resp, err := l.UnsImportJobDetail(&req)
		if err != nil {
