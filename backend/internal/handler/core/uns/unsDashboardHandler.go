...
func UnsDashboardHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UnsDashboardReq
		...
		l := uns.NewUnsDashboardLogic(r.Context(), svcCtx)
		resp, err := l.UnsDashboard(&req)
		if err != nil {
