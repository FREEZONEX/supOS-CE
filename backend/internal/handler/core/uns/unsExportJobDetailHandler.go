...
func UnsExportJobDetailHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.JobIdReq
		...
		l := uns.NewUnsExportJobDetailLogic(r.Context(), svcCtx)
		resp, err := l.UnsExportJobDetail(&req)
		if err != nil {
