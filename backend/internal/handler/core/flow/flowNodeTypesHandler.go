...
func FlowNodeTypesHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.NodeRedNodeTypeListReq
		...
		l := flow.NewFlowNodeTypesLogic(r.Context(), svcCtx)
		resp, err := l.FlowNodeTypes(&req)
		if err != nil {
