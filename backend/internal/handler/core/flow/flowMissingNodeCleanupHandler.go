...
func FlowMissingNodeCleanupHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.NodeRedMissingNodeCleanupReq
		...
		l := flow.NewFlowMissingNodeCleanupLogic(r.Context(), svcCtx)
		resp, err := l.FlowMissingNodeCleanup(&req)
		if err != nil {
