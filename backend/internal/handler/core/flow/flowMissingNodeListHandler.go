...
func FlowMissingNodeListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.NodeRedMissingNodeListReq
		...
		l := flow.NewFlowMissingNodeListLogic(r.Context(), svcCtx)
		resp, err := l.FlowMissingNodeList(&req)
		if err != nil {
