...
func FlowMissingNodeDeleteHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := flow.NewFlowMissingNodeDeleteLogic(r.Context(), svcCtx)
		resp, err := l.FlowMissingNodeDelete(&req)
		if err != nil {
