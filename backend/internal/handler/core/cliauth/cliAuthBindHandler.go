...
func CliAuthBindHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CliAuthBindReq
		...
		l := cliauth.NewCliAuthBindLogic(r.Context(), svcCtx)
		resp, err := l.CliAuthBind(&req)
		if err != nil {
