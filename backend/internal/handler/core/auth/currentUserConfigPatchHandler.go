...
func CurrentUserConfigPatchHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := auth.NewCurrentUserConfigPatchLogic(r.Context(), svcCtx)
		resp, err := l.CurrentUserConfigPatch(&req)
		if err != nil {
