...
func CurrentUserConfigPutHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := auth.NewCurrentUserConfigPutLogic(r.Context(), svcCtx)
		resp, err := l.CurrentUserConfigPut(&req)
		if err != nil {
