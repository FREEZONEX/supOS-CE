...
func CurrentUserProfileUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CurrentUserProfileReq
		...
		l := auth.NewCurrentUserProfileUpdateLogic(r.Context(), svcCtx)
		resp, err := l.CurrentUserProfileUpdate(&req)
		if err != nil {
